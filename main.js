...
//punho branca
  ...
  bntcorvistaDbranco.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#9C9B96";
    document.getElementById('VD').style.backgroundColor = "#9C9B96";
  });

  //vistaD preta
  const btncorvistaDpreto = document.getElementById('blackbase6');
  btncorvistaDpreto.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#6F726B";
    document.getElementById('VD').style.backgroundColor = "#6F726B";
  });
  //vistaD azul
  const btncorvistaDazul = document.getElementById('bluebase6');
  btncorvistaDazul.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#677B8B";
    document.getElementById('VD').style.backgroundColor = "#677B8B";
  });    
  //vistaD vermelha
  ...
  bntcorbolsoFbranco.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#9C9B96";
    document.getElementById('BSF').style.backgroundColor = "#9C9B96";
  });

  //Bolso Faixa preta
  const btncorbolsoFpreto = document.getElementById('blackbase7');
  btncorbolsoFpreto.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#6F726B";
    document.getElementById('BSF').style.backgroundColor = "#6F726B";
  });
  //Bolso Faixa azul
  const btncorbolsoFazul = document.getElementById('bluebase7');
  btncorbolsoFazul.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#677B8B";
    document.getElementById('BSF').style.backgroundColor = "#677B8B";
  });    
  ...
  bntcorbolsoBbranco.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#9C9B96";
    document.getElementById('BB').style.backgroundColor = "#9C9B96";
  });

  //Bolso Faixa preta
  const btncorbolsoBpreto = document.getElementById('blackbase8');
  btncorbolsoBpreto.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#6F726B";
    document.getElementById('BB').style.backgroundColor = "#6F726B";
  });
  //Bolso Faixa azul
  const btncorbolsoBazul = document.getElementById('bluebase8');
  btncorbolsoBazul.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#677B8B";
    document.getElementById('BB').style.backgroundColor = "#677B8B";
  });    
  //Bolso Faixa vermelha
